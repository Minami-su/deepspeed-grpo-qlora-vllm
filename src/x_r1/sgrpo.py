...
from trl.trainer.utils import get_quantization_config, get_kbit_device_map
from rewards import (
    accuracy_reward,
    format_reward,
...
from s_grpo_trainer import SGRPOTrainer
...
def main(script_args, training_args, model_args):
    ...
    #if model_args.model_name_or_path.find("Qwen") != -1 or model_args.model_name_or_path.find("xiaoyun") != -1 or model_args.model_name_or_path.find("PsyLLM") != -1:
...
if __name__ == "__main__":
    parser = TrlParser((GRPOScriptArguments, SGRPOConfig, ModelConfig))
